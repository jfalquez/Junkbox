#ifndef _DTRACK_VICON_CONFIG_H_
#define _DTRACK_VICON_CONFIG_H_

#include <CVars/CVar.h>
#include <Utils/CVarHelpers.h>


class DTrackViconConfig
{
public:
    DTrackViconConfig() :
        ...
        // KEYFRAME OPTIONS
        g_fCloseKeyframeNorm( CVarUtils::CreateCVar<>( "FrontEnd.CloseKeyframeNorm", 5.0f, "Maximum norm for keyframes to be selected in a neighborhood." ) ),
